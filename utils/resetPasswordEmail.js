const ResetPasswordEmail = (first_name, location, device, otp)=>{
  return `
          <!DOCTYPE html>
          <html lang="en">
          <head>
          ...
          <body>
              ...
              <div class="main">
                  ...
                  <div class="content-wrapper">
                      ...
                      <span class="accent">Reset</span> Your Password
                      </p>
                      <div class="content-body">
                      <div>
                          <p>Hi, ${first_name},</p>
                          <p>
                          You received this email because a user with location/device
                          ${location} / ${device} <!-- query to get the request location and use here --> asked for a
                          password change.
                          </p>
                      </div>
                      <div>
                          <p>
                          If you requested this password change, use the “Reset
                          Password” OTP code sent below to change your Konectin Account
                          Password
                          </p>
                      </div>
                      <div class="cta">
                          <button class="cta-btn">${otp}</button>
                      </div>
                      <div>
                          *** Note, the OTP above only works for
                          ...
                          Do not disclose this OTP Code to anybody
                          </p>
                      </div>
                      </div>
                  </div>
